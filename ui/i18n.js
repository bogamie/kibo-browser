...
const I18N = {
  ...
  zoom_reset:      { en: 'Reset zoom to 100%',         ko: '확대/축소 100%로 재설정' },
  ...
  update_prompt:   { en: (origin, user) => `Update the ${user ? `'${user}' ` : ''}password for ${origin}?`,
                     ko: (origin, user) => `${origin}의 ${user ? `'${user}' ` : ''}비밀번호를 업데이트할까요?` },
  update_accept:   { en: 'Update',                     ko: '업데이트' },
  ...
  bm_more:         { en: 'More bookmarks',             ko: '북마크 더 보기' },
  ...
  pass_hide:          { en: 'Hide',                    ko: '숨기기' },
  delete:             { en: 'Delete',                  ko: '삭제' },
  // master password (vault lock)
  pass_masterOn:      { en: 'Set master password',     ko: '마스터 비밀번호 설정' },
  pass_masterOff:     { en: 'Turn off master password', ko: '마스터 비밀번호 끄기' },
  pass_lockNow:       { en: 'Lock',                    ko: '잠금' },
  pass_lockedNote:    { en: 'The password vault is locked. Enter your master password to unlock.', ko: '비밀번호 보관함이 잠겨 있습니다. 마스터 비밀번호를 입력해 잠금을 해제하세요.' },
  pass_masterPh:      { en: 'Master password',         ko: '마스터 비밀번호' },
  pass_unlock:        { en: 'Unlock',                  ko: '잠금 해제' },
  pass_wrong:         { en: 'Wrong master password.',  ko: '마스터 비밀번호가 올바르지 않습니다.' },
  pass_masterSetNote: { en: 'Encrypts the vault with a password only you know — it auto-locks after idle. If you forget it, saved passwords cannot be recovered.', ko: '보관함을 당신만 아는 비밀번호로 암호화하며, 일정 시간 후 자동 잠깁니다. 잊으면 저장된 비밀번호를 복구할 수 없습니다.' },
  pass_masterNew:     { en: 'New master password',     ko: '새 마스터 비밀번호' },
  pass_masterConfirm: { en: 'Confirm master password', ko: '마스터 비밀번호 확인' },
  pass_masterMismatch:{ en: "Passwords don't match.",  ko: '비밀번호가 일치하지 않습니다.' },
  pass_masterFail:    { en: 'Could not set the master password.', ko: '마스터 비밀번호를 설정할 수 없습니다.' },
  pass_masterSave:    { en: 'Set',                     ko: '설정' },
  pass_cancel:        { en: 'Cancel',                  ko: '취소' },
  // password manager (search / sort / detail / add / edit / generator)
  pass_searchPh:      { en: 'Search saved passwords',  ko: '저장된 비밀번호 검색' },
  pass_noResults:     { en: 'No matches',              ko: '일치하는 항목이 없습니다' },
  pass_selectHint:    { en: 'Select an account to see details', ko: '계정을 선택하면 상세 정보가 표시됩니다' },
  pass_add:           { en: 'Add',                     ko: '추가' },
  pass_addTitle:      { en: 'Add password',            ko: '비밀번호 추가' },
  pass_editTitle:     { en: 'Edit password',           ko: '비밀번호 수정' },
  pass_fieldSite:     { en: 'Website address',         ko: '웹사이트 주소' },
  pass_fieldUser:     { en: 'Username',                ko: '아이디' },
  pass_fieldPass:     { en: 'Password',                ko: '비밀번호' },
  pass_sitePh:        { en: 'example.com',             ko: 'example.com' },
  pass_userPh:        { en: 'Username (optional)',     ko: '아이디 (선택)' },
  pass_passPh:        { en: 'Password',                ko: '비밀번호' },
  pass_copy:          { en: 'Copy',                    ko: '복사' },
  pass_copied:        { en: 'Copied',                  ko: '복사됨' },
  pass_open:          { en: 'Open website',            ko: '웹사이트 열기' },
  pass_edit:          { en: 'Edit',                    ko: '수정' },
  pass_save:          { en: 'Save',                    ko: '저장' },
  pass_deleteConfirm: { en: 'Delete?',                 ko: '삭제할까요?' },
  pass_errSite:       { en: 'Enter a website.',        ko: '웹사이트를 입력하세요.' },
  pass_errPass:       { en: 'Enter a password.',       ko: '비밀번호를 입력하세요.' },
  pass_errSave:       { en: 'Could not save.',         ko: '저장할 수 없습니다.' },
  pass_gen:           { en: 'Generate',                ko: '생성' },
  pass_genLen:        { en: 'Length',                  ko: '길이' },
  pass_genUpper:      { en: 'A-Z',                     ko: 'A-Z' },
  pass_genLower:      { en: 'a-z',                     ko: 'a-z' },
  pass_genDigit:      { en: '0-9',                     ko: '0-9' },
  pass_genSymbol:     { en: 'Symbols',                 ko: '기호' },
  pass_genSymbolsPh:  { en: 'Allowed symbols',         ko: '허용 기호' },
  pass_regenerate:    { en: 'Regenerate',              ko: '다시 생성' },
  pass_sortBy:        { en: 'Sort by',                 ko: '정렬' },
  pass_sortNameAsc:   { en: 'Name (A-Z)',             ko: '이름 (A-Z)' },
  pass_sortNameDesc:  { en: 'Name (Z-A)',             ko: '이름 (Z-A)' },
  pass_sortUserAsc:   { en: 'Username (A-Z)',         ko: '아이디 (A-Z)' },
  pass_sortUserDesc:  { en: 'Username (Z-A)',         ko: '아이디 (Z-A)' },
  pass_sortModified:  { en: 'Last Modified',          ko: '최근 수정' },
  pass_count:         { en: (n) => `${n} passwords`,  ko: (n) => `비밀번호 ${n}개` },
